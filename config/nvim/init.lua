...
vim.keymap.set('n', '<leader>bR', "<cmd>Gitsigns reset_buffer<cr>", { silent = true })
...
vim.keymap.set('n', '<leader>hj', "<cmd>Gitsigns next_hunk<cr>", { silent = true })
vim.keymap.set('n', '<leader>hk', "<cmd>Gitsigns prev_hunk<cr>", { silent = true })
...
require('nvim-treesitter.configs').setup {
    ...
    ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'ruby', 'terraform' },
...
local on_attach = function(_, bufnr)
    ...
    vim.keymap.set('n', '<Leader>co', function() require('dap').step_over() end)
    vim.keymap.set('n', '<Leader>ci', function() require('dap').step_into() end)
    vim.keymap.set('n', '<Leader>cO', function() require('dap').step_out() end)
    vim.keymap.set('n', '<Leader>cb', function() require('dap').toggle_breakpoint() end)
    vim.keymap.set('n', '<Leader>cB', function() require('dap').set_breakpoint() end)
    vim.keymap.set('n', '<Leader>cp',
        function() require('dap').set_breakpoint(nil, nil, vim.fn.input('Log point message: ')) end)
    vim.keymap.set('n', '<Leader>cr', function() require('dap').repl.open() end)
    vim.keymap.set('n', '<Leader>cl', function() require('dap').run_last() end)
end
...
local servers = {
    ...
    terraformls = {
        terraform = {
            ...
            languageServer = { terraform = { timeout = '60s' } }
        }
    },
    -- tflint = {},
    powershell_es = {
...
-- why you no work??? vim.opt.iskeyword:append({'_'})
